#!/usr/bin/env node
/**
 * Mock coding-agent CLI — stands in for Codex / the DeepSeek TUI so the demo runs
 * with no API key, deterministically. What it proves: it operates ENTIRELY inside
 * its cwd (the shared project repo), reading the shared spec + progress log and
