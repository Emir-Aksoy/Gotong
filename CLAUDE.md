...
- **STD 标准对齐 track：名片签名 M0→M1（2026-07-07，`c6ceab4`→`68a1c97` 共 2 commit）**
  ...
  **M0**（`c6ceab4`）计划 [`docs/zh/STD-STANDARDS-ALIGNMENT.md`](docs/zh/STD-STANDARDS-ALIGNMENT.md)
  ...
  2973/2980，server.ts 2345/2350）。**M2 下一步**：消费侧 peer-card 验签 ✓✗ + onboarding PIN
  公钥（发现≠信任在此长牙，`verifyAgentCardSignature` 已备）。
