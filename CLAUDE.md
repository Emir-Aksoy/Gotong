...
| 出站 ACP 长连接 adapter (模仿 OpenClaw; hub spawn 一次 hold ACP session 反复派任务, Claude Code/Codex; 五缝 + `session/request_permission` 逐动作 T2 闸 + 内存权限耦合边界 + 确定性 §5 门 + M8 真机门) | `docs/zh/V5-ACP-ADAPTER.md` |
