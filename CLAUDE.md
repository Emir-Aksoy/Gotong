...
| **v4 Phase 12 M9-M11** | **进行中** | PWA + mobile responsive + 移动简化 shell |
| **下一步** | (Phase 13 完整完成) | 没有强制路线 — 备选: PWA + mobile (Phase 12 M9-M11, 进行中) / admin.js 深拆 workflow-start 共享渲染层 / 微信小程序 |
...
| 进行中 | Phase 12 M9-M11 PWA + mobile responsive + 移动简化 shell | 1-2 周 |
