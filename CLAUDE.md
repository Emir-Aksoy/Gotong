...
- **BE 管家增强（BE-M1→M6 全完，默认开）** — 补缺口 3「管家作为『用户↔框架』中间层还缺眼睛」：
  ...
  事**。详见 [`docs/zh/BUTLER-EMPOWER-FINAL.md`](docs/zh/BUTLER-EMPOWER-FINAL.md)。
...
- **PRO track（PRO-M1→M2 全完，默认 unset=字节不变）** ✅ — `AIPE_PROFILE=hub|federation`
  ...
  [`docs/zh/DEPLOYMENT-PROFILE.md`](docs/zh/DEPLOYMENT-PROFILE.md)。**剩 DOC track（考古层
  归档 + 主线金字塔）**收口本缺口的文档侧。
...
[`docs/zh/BUTLER-EMPOWER-FINAL.md`](docs/zh/BUTLER-EMPOWER-FINAL.md)。
...
| 管家增强（观察面三读 + 诊断闭环 + create_workflow + ask_my_agent + 运行零 LLM 播报；五缝复用既有成员 surface） | `docs/zh/BUTLER-EMPOWER-FINAL.md` |
