...
| **v4 Phase 11** | **下一步** | Long-running agent (suspend/resume + working memory) |
...
| Long-running agent | 靠 deadline + retry | **Phase 11** — 加 `agent.suspend(resumeAt)` + 持久化 working memory |
