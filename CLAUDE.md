...
- **FDE 前置部署 track（M0→M1b 收口，`c04a7db`/`96d826b`/`a1d3c12`）** — 用户战略定调：框架要
  ...
  **现算**永不过期；未挂一律**黄牌**——optional:false 也不红，红牌只留 host 亲证事实，第三方
  ...
  棘轮再降（main 3250 / server 2350 / me-routes 2850）。验收 host 1700 / web 1242 / 四门
  PASS。M2（golden-run 验收压试跑闸）/ M3（按方案开荒一条命令）在途。
