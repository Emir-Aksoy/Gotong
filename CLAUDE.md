...
- **STD 标准对齐 track：名片签名 M0→M2a（2026-07-07，`c6ceab4`→`168245c` 共 4 commit）**
  ...
  **M0**（`c6ceab4`）计划 [`docs/zh/STD-STANDARDS-ALIGNMENT.md`](docs/zh/STD-STANDARDS-ALIGNMENT.md)
  ...
  断言 ALL PASS；a2a 55/cli 248/host 1882 全绿，四门 PASS。**M2b 下一步**：onboarding PIN 公钥
  =身份锚（owner 显式确认才 PIN，永不 TOFU 自动信任）。
