...
examples/                       39 个端到端 demo (含 Phase 19 P5 activepieces-bridge / windmill-bridge; v5 Stream E coding-agent-bridge / obsidian-kb / elasticsearch-kb; Stream G cross-hub-workflow; 上手案例 personal-coding-hub + personal-research-hub + battle-monk-training; 组织 hub cafe-ops [管理面] + warband-club [协作面] + tea-supply-link [跨组织面 shop→supplier] + tea-chain-hq [跨组织面 HQ→shop])
docs/  docs/zh/                 双语文档
