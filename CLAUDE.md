...
examples/                       33 个端到端 demo (含 Phase 19 P5 activepieces-bridge / windmill-bridge; v5 Stream E coding-agent-bridge / obsidian-kb / elasticsearch-kb; 上手案例 personal-coding-hub + personal-research-hub)
docs/  docs/zh/                 双语文档
