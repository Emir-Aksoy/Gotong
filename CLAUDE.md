...
examples/                       36 个端到端 demo (含 Phase 19 P5 activepieces-bridge / windmill-bridge; v5 Stream E coding-agent-bridge / obsidian-kb / elasticsearch-kb; 上手案例 personal-coding-hub + personal-research-hub + battle-monk-training; 组织 hub cafe-ops [管理面] + warband-club [协作面])
docs/  docs/zh/                 双语文档
