...
// line-budget relief). The member-facing *Surface duck types + *View
// projections + *Result unions, plus the pure memberUploadScope helper.
// Imported back for local signatures + HandleMeRouteCtx below, and re-exported
// so './me-routes.js' stays the import point server.ts and tests use.
import { memberUploadScope } from './me-routes-types.js'
import type {
...
export type {
  ...
  InboxItemView,
  InboxSurface,
  MeWorkflowBoundaryView,
  MeWorkflowBoundaryViolationView,
