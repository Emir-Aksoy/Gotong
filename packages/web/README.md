...
Embeddable reference web UI for [Gotong](https://github.com/Emir-Aksoy/Gotong). A zero-dependency vanilla-JS SPA served by a small Node HTTP + SSE server, talking to your `Hub` via its event stream.
