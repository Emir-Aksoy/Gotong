...
(() => {
  const I18N = {
    zh: {
      ...
      colActions: '操作',
      wfAssistModalTitle: 'AI 助手 — 生成工作流草稿',
    ...
    en: {
      ...
      setupSubmitMeta: 'You will be redirected to sign-in afterward.',
      ...
      colActions: 'Actions',
      wfAssistModalTitle: 'AI assistant — generate workflow draft',
