...
const CARDS = [
  ...
  },
  {
    ...
    body: [
      ...
      '- 子集档也可以直接跟我说「打一份身份档备份」——我先送你批准再动手,档案落在服务器空间的 backups/ 下(仅 owner/admin;全量/搬家档仍走命令行)。',
  ...
  },
  {
    ...
    body: [
      ...
      '**先送你确认再动**:改 hub 基础设置(端口/模式/首启开浏览器)、建改助手与工作流 —— 送进你的待办后 `/approve <短码>` 就能在聊天窗批(设置改动下次重启生效)。工作区里的联网命令同样要你点头,但**只能去网页批**:那一行命令原文要你逐字读过才算数。',
