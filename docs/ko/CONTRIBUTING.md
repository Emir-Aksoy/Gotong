...
기여를 고려해 주셔서 감사합니다. AipeHub는 초기 단계 프로젝트로,
패치, 버그 리포트, 설계 피드백, 문서 개선을 환영합니다.
...
- **허브는 단순하게 유지합니다.** AipeHub의 설계 원칙은 허브가 라우팅 /
...
TypeScript를 작성하지 않아도 기여할 수 있습니다. AipeHub는 **템플릿**을
