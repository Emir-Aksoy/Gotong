# Gotong v4 Phase 4 ——「跨组织 federation」
...
import { installPeerLink, Hub } from '@gotong/core'
import { connectHubLink } from '@gotong/transport-ws'

const identity = openIdentityStore({ dbPath: '.gotong/identity.sqlite' })
