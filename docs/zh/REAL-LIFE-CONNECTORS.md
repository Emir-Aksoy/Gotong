...
>
> Last updated: 2026-07-08 · C-M1 done · C-M2 出站 OAuth:M1 纯核 + M2 存储层 + M3 连接流 + M4a 活令牌注入 + M4b 自动刷新 + M5a admin CRUD 后端 + M5b 目录预设(Google 日历 + Gmail)done(M5c UI / M5d capstone 收尾;Notion-OAuth 待 M1 加 basic 认证)。
