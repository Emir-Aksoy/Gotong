...
RFC 待写; 入口在 `docs/zh/V4-PHASE7-13-PLAN.md` 的 Phase 10 段.
...
| 文件 | 用途 |
|---|---|
| `docs/zh/V4-PHASE9-FINAL.md` | 本文 — release notes / hand-off |
| `docs/zh/PHASE9-MULTIMODAL-RFC.md` | M1 设计决策记录(6 决策) |
