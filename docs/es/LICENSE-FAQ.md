...
> **Gotong en su totalidad tiene licencia bajo la [Licencia MIT](../../LICENSE).**
...
## 1. ¿Puedo incrustar Gotong en mi producto de código cerrado / SaaS / herramienta interna?

**Sí.** MIT está entre las licencias OSS más permisivas. Permite:

- ✅ Uso comercial, incluido reempaquetar todo Gotong y venderlo
- ✅ Modificar el código fuente, renombrarlo (aunque si lo renombras, por favor di "basado en Gotong")
- ✅ Derivados de código cerrado — tus cambios **no** tienen que ser de código abierto
- ✅ Incluir `@gotong/core` en un SaaS de código cerrado como dependencia npm

**El único requisito estricto**: mantener el archivo LICENSE + el aviso de
copyright (listar Gotong en la página NOTICE / Third-Party-Licenses de tu producto
es suficiente).
...
- ⚠️ Pero **debes mantener, en algún lugar** (p.ej. NOTICE.md o
  THIRD-PARTY.md), el texto MIT original de Gotong + la línea de copyright upstream
- ❌ **No puedes** afirmar "Gotong es nuestro trabajo original" — eso es
...
**Ninguno en el lado de Gotong.** Los prompts que tú o tu empresa escribís son
activos propios de tu empresa; Gotong es solo el contenedor de tiempo de ejecución.
...
Ninguno es algo que el proyecto Gotong gobierne — MIT licencia el software en sí,
no el contenido que generas con él.

---

## 6. Estoy desplegando Gotong dentro de la intranet de un cliente — ¿qué archivos de licencia entrego?

Como mínimo:

- El archivo `LICENSE` de la raíz del repositorio de Gotong
- Si usas `templates/community/`: trae también `LICENSE-NOTICES.md`
- Si incrustas el paquete npm `@gotong/core`: el paquete incluye su propia
  licencia en la instalación; la redistribución downstream solo necesita mantener
  `node_modules/@gotong/*/LICENSE` sin eliminar

Un patrón común es una página de "Licencias de terceros" en tu producto que lista
todos los textos de licencias OSS upstream. Añade el MIT de Gotong ahí y listo.

---

## 7. ¿Las dependencias de tiempo de ejecución de Gotong contienen copyleft estilo GPL/AGPL?
...
## 8. ¿El protocolo wire de Gotong es parte de la licencia?
...
## 10. ¿Mi empresa puede bifurcar Gotong internamente sin abrir el código del fork?
...
Siempre que **el entregable final mantenga la licencia MIT original de Gotong en
