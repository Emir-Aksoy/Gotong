...
1. Ouvrez `https://github.com/Emir-Aksoy/AipeHub/settings` (**Paramètres** du dépôt).
...
Après avoir activé Discussions, **copiez tout le bloc ci-dessous**, postez une nouvelle Discussion dans la catégorie **General** avec le titre `👋 欢迎来到 AipeHub 客厅 / Welcome`, et cliquez sur **Pin**. Le brouillon original commence par le chinois (l'audience principale de la communauté) puis l'anglais ; réordonnez selon votre public.
