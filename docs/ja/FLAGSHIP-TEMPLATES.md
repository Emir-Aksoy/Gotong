...
Gotong の差別化要因は「AI を呼び出せる」ことではありません — それはどこにでもあります。それは**AI を自宅、家族、お金に向ける勇気が持てる**ことです。なぜなら境界は本物であり、あなたのものだからです:
...
- **キーとデータはあなた自身のディスク上にあります。** クレデンシャルはあなたの `.gotong/` ディレクトリに暗号化されています。別のハブとフェデレーションすると**能力**が共有されますが、あなたの Vault は共有されません。
